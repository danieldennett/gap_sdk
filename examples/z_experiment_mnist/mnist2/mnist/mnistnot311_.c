 ...
 *
 */
//        MNIST PLAY WITH     PI_L2_MALLOC AND AT_L2_ALLOC
...
int test_mnist(void)
{
  ...
  // unsigned char *ImageIn = (image_in_t *) pi_l2_malloc(sizeof(image_in_t)*AT_INPUT_WIDTH*AT_INPUT_HEIGHT*AT_INPUT_COLORS);
    if (!(ImageIn = (image_in_t *) pi_l2_malloc(AT_INPUT_SIZE_BYTES))) {

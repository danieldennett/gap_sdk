...
//    AT_SetGraphCtrl(AT_GRAPH_REORDER_CONSTANT_IN, AT_OPT_ON);
    ...
    // MAX_POOL_2D_0_3
    CNN_PoolReLU("S3_MaxPool_2x2", 0, 1, 1, 1, 1, 32, 32, 10, 10,
        KOP_MAXPOOL, 2, 2, 1, 1, 2, 2, 0, KOP_NONE);
    // FULLY_CONNECTED_0_4
    CNN_LinearReLU("S4_Linear_10x32x5x5", 0, 1, 1, 1, 1, 1, 1, 1, 1, 800, 10,
        KOP_LINEAR, KOP_NONE);
    // SOFTMAX_0_5
...
#define GRAPH
    ...
    // Node MAX_POOL_2D_0_3 inq 2 outq 2
    AddNode("S3_MaxPool_2x2", Bindings(2, GNodeArg(GNA_IN, "OutputStep3", 0), GNodeArg(GNA_OUT, "OutputStep4", 0)));
    // Node FULLY_CONNECTED_0_4 inq 2 weightsq 6 outq 1
    AddNode("S4_Linear_10x32x5x5", Bindings(6, GNodeArg(GNA_IN, "OutputStep4", 0), GNodeArg(GNA_IN, "Step4Weights", 0), GNodeArg(GNA_IN, "Step4Biases", 0), GNodeArg(GNA_OUT, "OutputStep5", 0), Imm(7), Imm(7)));

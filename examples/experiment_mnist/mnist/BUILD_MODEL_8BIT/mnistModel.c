...
#define GRAPH
    ...
    CreateGraph("mnistCNN",
        ...
        CArgs(8,
            ...
            TCArgInfo("signed char *__restrict__", "Step3Biases", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_8BIT/tensors/Step3Biases.tensor", 1, 1, 8, 7)),
    ...
    // Node S1_Conv2d_32x1x5x5_MaxPool_2x2_Relu inq 7 weightsq 7 outq 6 biasesq 7
    AddNode("S1_Conv2d_32x1x5x5_MaxPool_2x2_Relu", Bindings(6, GNodeArg(GNA_IN, "Input_1", 0), GNodeArg(GNA_IN, "Step1Weights", 0), GNodeArg(GNA_IN, "Step1Biases", 0), GNodeArg(GNA_OUT, "OutputStep1", 0), Imm(8), Imm(9)));
    ...
    AddNode("S3_Linear_10x64x4x4", Bindings(6, GNodeArg(GNA_IN, "OutputStep2", 0), GNodeArg(GNA_IN, "Step3Weights", 0), GNodeArg(GNA_IN, "Step3Biases", 0), GNodeArg(GNA_OUT, "OutputStep3", 0), Imm(9), Imm(4)));
    // Node SOFTMAX_0_5 inq 2 outq 15
    AddNode("S4_SoftMax", Bindings(3, GNodeArg(GNA_IN, "OutputStep3", 0), GNodeArg(GNA_OUT, "Output_1", 0), Imm(2)));
    CloseGraph();
#endif
}

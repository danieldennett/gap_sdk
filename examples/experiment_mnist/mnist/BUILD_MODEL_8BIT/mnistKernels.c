...
void S1_Conv2d_32x1x5x5_MaxPool_2x2_Relu(
...
{
	/* Shared L1: 44000 bytes, L2 buffer: 7136 bytes */
	...
	User Kernel Iteration Space:
		[D1 Dim: 1][Tile0 Dim: 2][D0 Dim: 1]
	Ker Arg: Out, Tiled Space: Tile0
		Min Pipe Depth: -1, Max Pipe Depth: 0
		KerArgItSpace: 2 logical tiles, 2 physical tiles
			Total Size: 4608 [D1, 1 x 4608][Tile0, 2:[12x6, 12x6], 1]
		KerArgItSpace (User Kernel Iter Order):
			[D1, 1 x 4608][Tile0, 2:[12x6, 12x6], 1]
		Tile0: [0, 2304, 72], Tile1: [72, 2304, 72], Tile2; [0, 0, 0]
		T0: [D1: 0][Tile0: 0], T1: [D1: 0][Tile0: 1], T2: [D1: 0][Tile0: 0]
	...
	Ker Arg: In, Tiled Space: Tile0
		Min Pipe Depth: 0, Max Pipe Depth: 1
		KerArgItSpace: 2 logical tiles, 2 physical tiles
			Total Size: 784 [D0, 1 x 784][Tile0, 2:[28x16, 28x16], 1]
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 2:[28x16, 28x16], 1][D0, 1 x 784]
		Tile0: [0, 448, 448], Tile1: [336, 448, 448], Tile2; [0, 0, 0]
		T0: [D0: 0][Tile0: 0], T1: [D0: 0][Tile0: 1], T2: [D0: 0][Tile0: 0]
	Ker Arg: ConvOut, Tiled Space: Buffer
		Min Pipe Depth: 0, Max Pipe Depth: 0
		KerArgItSpace: 2 logical tiles, 1 physical tiles
			Total Size: 73728 [D1, 1 x 73728][Tile0, 2:[24x12, 24x12], 4]
		KerArgItSpace (User Kernel Iter Order):
			[D1, 1 x 73728][Tile0, 2:[24x12, 24x12], 4]
		Tile0: [0, 73728, 73728], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [D1: 0][Tile0: 0], T1: [D1: 0][Tile0: 0], T2: [D1: 0][Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*=========================== Call Kernel, Invariant assignment =====================*/
	KerArg0->Out = (int * __restrict__) (L1_Memory+7136);
	KerArg0->W = (unsigned short int) (24);
	KerArg0->H = (unsigned short int) (12);
	KerArg0->OutFeatures = (unsigned short int) (32);
	KerArg0->Bias = (signed char * __restrict__) (L1_Memory+896);
	...
	_SP_Out=0;
	AT_L2_COPY(0, ((AT_L2_EXT_ADDR_TYPE) Bias+0), ((AT_L2_INT_ADDR_TYPE) L1_Memory+896), 32, 0, &DmaR_Evt1);
	AT_L2_WAIT(0, &DmaR_Evt1); /* Wait previous DMA read Bias */
	_N_Filter=0;
	AT_L2_COPY(0, ((AT_L2_EXT_ADDR_TYPE) Filter+0), ((AT_L2_INT_ADDR_TYPE) L1_Memory+928+0), 800, 0, &DmaR_Evt2);
	_N_In=0;
	AT_L2_COPY(0, ((AT_L2_EXT_ADDR_TYPE) In+0), ((AT_L2_INT_ADDR_TYPE) L1_Memory+0+0), 448, 0, &DmaR_Evt3);
	...
	{ /* Single iteration on D1 */
		...
		if (_SN_Filter) {
			AT_L2_COPY(0, ((AT_L2_EXT_ADDR_TYPE) Filter+_N_Filter), ((AT_L2_INT_ADDR_TYPE) L1_Memory+928+800*((D1Ind_Total+1)%2)),
		...
		for (T0Ind=0; T0Ind<2; T0Ind++, T0Ind_Total++) { /* Iteration on Tile0 */
			...
			{ /* Single iteration on D0 */
				...
				if (_SN_In) {
					AT_L2_COPY(0, ((AT_L2_EXT_ADDR_TYPE) In+_N_In), ((AT_L2_INT_ADDR_TYPE) L1_Memory+0+448*((D0Ind_Total+1)%2)),
							_SN_In, 0, &DmaR_Evt3);
				}
				/*============================= End Read Tiles ======================================*/
				/*====================== Call Kernel LOC_D0 =========================*/
				KerArg1->In = (signed char * __restrict__) (L1_Memory+0+448*((D0Ind_Total)%2));
				KerArg1->Filter = (signed char * __restrict__) (L1_Memory+928+800*((D1Ind_Total)%2));
			...
			KerArg3->Out = (signed char * __restrict__) (L1_Memory+2528+2304*((T0Ind_Total)%2));
			AT_FORK(gap_ncore(), (void *) KerParPool2x2Stride2_fps, (void *) KerArg3);
			__CALL(KerParPool2x2Stride2_fps, KerArg3);
			/*================================= Write Tiles =====================================*/
			if (_SP_Out) AT_L2_WAIT(0, &DmaW_Evt1); /* Wait previous DMA write Out */
			AT_L2_COPY2D(0, ((AT_L2_EXT_ADDR_TYPE) Out+_C_Out), ((AT_L2_INT_ADDR_TYPE) L1_Memory+2528+2304*((T0Ind_Total)%2)),
...
unsigned int AT_GraphPerf[4];
unsigned int AT_GraphOperInfosNames[4] = {
	483840,
	3281920,
	10240,
	10,
};
char *AT_GraphNodeNames[4] = {

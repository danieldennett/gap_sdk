...
#endif  /* PRINT_IMAGE */
// changed 10 to 2 as I changed the example number of classes 
...
int main()
{
    ...
    #else
    ImageName = "/home/zhouxin/gap_sdk/examples/nntool/mnist/samples/frame_1.pgm";
